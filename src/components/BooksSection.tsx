  ...
  return (
    <section id="books" className="section-padding bg-background">
      <div className="container-wide px-4 md:px-8" ref={ref}>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
